...
# import clean_slate
# import create_remove_from_prov
# import create_base_config
# import create_hosts_file
# import create_vsf_stacking_info
...
def create_remove_from_prov():
    ...
    #loads in the j2 and csv files
    remove_from_prov_j2 = os.path.expanduser("~/ansible/ansible_playbooks/refresh/j2_templates/remove_from_prov.j2")
    main_csv = os.path.expanduser("~/ansible/ansible_playbooks/refresh/main.csv")
    generated_configs_path = os.path.expanduser("~/ansible/ansible_playbooks/refresh/config_files/generated_configs")
